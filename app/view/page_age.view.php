...
<div class="form-annee">
  <label>
      <select name="annee" action="<?= URL ?>page_age.php" method='POST'>
...
<!--<p> Bonjour <?php //echo($_POST['annee']); ?>-->

<!--<div id="bouton">
    <a type="submit" id="valider" href="<?= URL ?>accueil.php"> onclick="ismajor('ddn')
        Valider
    </a>
</div>-->
...
<script async>
                function valide() {
                  var validation = document.getElementById('bouton');
                  var ddn = document.getElementsByClassName('form-annee')
