...
<head>
    <meta charset="UTF-8">
    <link rel="icon" type="image/png" href="public\images\logo_alda_blanc_sur_fond_noir.png"/>
        ...
        <header>
                <nav>
                    <ul class="menu">
                        ...
                        <li id="listlogo"><a href="index.php"><img id="logo" src="public\images\logo_alda_blanc_header.png"></a></li>
                        ...
                        <li><a href="pageVerifClient.php"><img id="caddie" src="public\images\caddie.png"></a></li>
                    </ul>
                </nav>
        </header>
